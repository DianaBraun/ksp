...
public class SearchPage extends BasePage {
    ...
    private final SelenideElement sizeFilter = $x("(//i[@class=\"icon-filter-arrow-down search-filter__item-arrow\"])[2]");
    private final SelenideElement colorFilter = $x("(//i[@class=\"icon-filter-arrow-down search-filter__item-arrow\"])[3]");
    private final SelenideElement priceFilter = $x("(//i[@class=\"icon-filter-arrow-down search-filter__item-arrow\"])[4]");
